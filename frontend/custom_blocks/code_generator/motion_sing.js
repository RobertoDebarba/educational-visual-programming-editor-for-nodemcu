Blockly.JavaScript['motion_sing'] = function (block) {
    ...
    if (dropdown_song === 'SUPER_MARIO') {
        code += 'playSuperMarioSong();\n';
    }
...
class MotionSingBlock {
    ...
    static getSetupCode() {
        ...
        if (this._hasBlockWithSong('SUPER_MARIO')) {
            code += this._happySuperMarioSong.getSetupCode();
        }
    ...
    static getGlobalInitCode() {
        ...
        if (this._hasBlockWithSong('SUPER_MARIO')) {
            code += this._happySuperMarioSong.getGlobalInitCode();
        }
    ...
    static getGlobalFunctionsCode() {
        ...
        if (this._hasBlockWithSong('SUPER_MARIO')) {
            code += this._happySuperMarioSong.getGlobalFunctionsCode();
        }
    ...
    static _happySuperMarioSong = {

        getSetupCode() {
            return `
            ////////////////////////////////////////////////////////////////////////////////////////
            ////////////////////////////////MOTION_DANCE SUPER MARIO////////////////////////////////
            ////////////////////////////////////////////////////////////////////////////////////////
